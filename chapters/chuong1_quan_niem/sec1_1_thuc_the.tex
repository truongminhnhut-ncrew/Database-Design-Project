...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{l c X p{4.2cm}}
        ...
        \texttt{MaCha} & $\circ$ & Khóa ngoại tự tham chiếu -- Mã Cha ruột trong gia phả & \texttt{MEM\_010} \\
        \rowcolor{tablerowalt}
        \texttt{MaMe} & $\circ$ & Khóa ngoại tự tham chiếu -- Mã Mẹ ruột trong gia phả & \texttt{MEM\_011} \\
        \texttt{MaChiToc} & $*$ & Khóa ngoại -- Chi tộc mà thành viên trực thuộc & \texttt{BRANCH\_01\_TRUONG} \\
        \rowcolor{tablerowalt}
