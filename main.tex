...
\colorlet{primaryblue}{blue}

% Cấu hình Định nghĩa và Ví dụ
...
\begin{center}
    ...
    \begin{minipage}[t]{0.45\textwidth}
        ...
        \indent ThS. Nguyễn Văn Chiến
    \end{minipage}
    \begin{minipage}[t]{0.5\textwidth}
        \textbf{Sinh viên thực hiện:}\\
        \indent 1. Trương Minh Nhựt\\
        \indent 2. Nguyễn Hoàng Minh Trí\\
        \indent 3. Nguyễn Ngọc Anh Thư\\
        \indent 4. Nguyễn Hoàng Phi\\
        \indent 5. Nguyễn Hưng
    \end{minipage}
...
\include{chapters/chuong1_quan_niem/main}

% Chương 2: Thiết kế Logic (Logical Design)
\include{chapters/chuong2_logic/main}

% Chương 3: Thiết kế Vật lý (Physical Design)
\include{chapters/chuong3_vat_ly/main}

% Đánh giá và Kết luận (Không đánh số chương)
\include{chapters/04_ket_luan}
